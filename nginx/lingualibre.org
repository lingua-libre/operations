server {
    ...
    listen 80;
    listen [::]:80;
    server_name dev.lingualibre.org;
...
server {
    ...
    ssl_certificate /etc/dev.letsencrypt/live/lingualibre.org/fullchain.pem;
    ssl_certificate_key /etc/dev.letsencrypt/live/lingualibre.org/privkey.pem;
    ...
    location =/robots.txt {
        alias /var/www/dev.lingualibre.org/robots.txt;
    }
